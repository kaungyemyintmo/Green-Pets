...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const callbackForPetInfo = (responseStatus, responseData) => {
   ...
   <div class="row">
     ...
     <img src=${petImgAry[storeId - 1]} class="img" style = "width: 200px" alt="pet image">
     </div>
     </div>
   </div>
 </div>
       <div class="row">
         <div class="col-md-12">
         <div class = "container d-flex justify-content-center"> 
         <div class="thought">${responseData[0].type} - ${responseData[0].points} points</div>
         </div>
         </div>
         <div class = "container d-flex justify-content-center" style="margin-bottom:50px"> 
         <div class="col-md-4"> </div>
         <div class="col-md-4 rounded" style= "background-color:#e6deff">
         <p>${responseData[0].msg}</p>
         </div>
         <div class="col-md-4" > </div>
         </div>
         <div class="col-md-12">
         <section class = "prompts bg-light rounded" style="padding: 50px">
         <section class="prompts bg-success bg-gradient rounded" >
         <div class="container">
         <div class="row justify-content-center mt-5">
           <div class="col-md-6 px-5">
          <form id="petForm">
            <div class="form-group pb-3">
              <label for="petName" class = "fs-5 text-light" style="padding-bottom: 30px">Give your pet a name : </label>
              <input type="text" class="form-control" id="petName" required>
            </div>

            <div class="form-group pb-3">
            <label for="color" class = "fs-5 text-light" style="padding-bottom: 30px">Give your pet a color : </label>
  ...
  fetchMethod(currentUrl + `/api/pet/${storeId}`, callbackForPetInfo);
})
...
function purchasePet(num) {
  ...
  fetchMethod(currentUrl + `/api/pet/${num}/purchase`, callbackForPurchase, "POST", data, token);
}
